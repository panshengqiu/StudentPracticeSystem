...
@Service
@Qualifier("departmentPostsComplexSelect")
public class DepartmentPostsComplexSelectImpl implements PostComplexService {
    @Autowired
    ...
    public List<Map<Object, Object>> selectPosts(List<String> postTypes, List<String> workCities, String status, HumanResource humanResource) {
        return postComplexSelectMapper.selectDepartmentPosts(postTypes,workCities,status,humanResource);
    }
}
